  ...
  return (
    <div>
      ...
      <Container>
        ...
        <Alert variant="warning" className="text-center mx-3 mb-5">This site is currently connected to the Ropsten testnet. Use gas limit of approx 100,000 Gwei.</Alert>
